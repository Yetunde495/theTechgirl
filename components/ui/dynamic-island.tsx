...
const DynamicIslandContent = ({
  ...
  return (
    <motion.div
      id={id}
      className="mx-auto h-0 w-0 items-center justify-center shadow-[inset_0_-1px_#d1d5db,inset_0_0_0_1px_#d1d5db,_0_4px_8px_#d1d5db] dark:shadow-[inset_0_-1px_#10171e,inset_0_0_0_1px_hsla(205,89%,46%,.24),_0_4px_8px_#00000052] border-[#ad46ff] [background:linear-gradient(to_bottom,#ad46ff,#713cbc)] text-center text-black transition duration-300 ease-in-out hover:shadow-md dark:border dark:border-white/5"
      animate={{
