        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full [background:linear-gradient(to_bottom,#ad46ff,#713cbc)] text-xl text-white flex items-center justify-center">
